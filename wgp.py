        ...
        with gr.Column(**column_kwargs):
            ...
            with gr.Row(visible= not audio_only) as number_frames_row:
                ...
                if image_outputs:
                    ...
                    video_length = gr.Slider(0 if audio_only else min_frames, get_max_frames(1737 if test_any_sliding_window(base_model_type) else 337), value=current_video_length, 
